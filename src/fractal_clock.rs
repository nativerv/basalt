...
impl FractalClock {
  pub fn ui(&mut self, ui: &mut Ui, seconds_since_midnight: Option<f64>) {
    let seconds_since_midnight = seconds_since_midnight.unwrap_or_else(|| ui.input(|i| i.time));
    self.time = seconds_since_midnight * f64::from(!self.paused) + self.offset as f64;
    ...
    Frame::popup(ui.style())
      ...
      .show(ui, |ui| {
        ...
        CollapsingHeader::new("Settings")
          .show(ui, |ui| self.options_ui(ui, Some(seconds_since_midnight)));
      });
  }
