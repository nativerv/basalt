...
/// Fork of `egui::SelectableLabel` with unlimited width
...
impl Widget for SelectableItem {
  fn ui(self, ui: &mut Ui) -> Response {
    ...
    response
      .widget_info(|| WidgetInfo::selected(WidgetType::SelectableLabel, selected, galley.text()));
